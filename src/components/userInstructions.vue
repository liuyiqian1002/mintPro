      ...
      <div class="notice_wrap">
        ...
        <div class="txt">
          <div class="doc">
            <div class="doc_top">
              ...
              <div>
                <img
                  src="../assets/images/common/userInstructions_top.png"
                  alt=""
                />
              </div>
            </div>
        ...
        <div class="btns">
          <div class="agree">
            ...
            <span>《{{ $t("base.protocol") }}》</span>
          </div>
          <button class="main_btn" @click="updateUserEntity">
            {{ $t("base.confirm") }}
          </button>
        </div>
      </div>
      ...
      if (this.nShow) {
        setTimeout((_) => {
          ...
          this.$refs.iframe.src =
            this.$config.imgPath +
            `/News/AppSynopsis/16515ae1-eb5b-4aa3-99cc-fc1ace43ede4?LanguageVersion=${this.lang}`;
...
.notice_wrap {
  height: 100vh;
  background: @background-linear; // background: linear-gradient( 145deg, #03C1A7 0%, #30AED4 100%);
  overflow: scroll;
...
.agree {
  ...
  label {
    ...
    b {
      ...
      width: 30px;
      height: 30px;
      background: url(../assets/images/common/reg_tologin_disagree.png)
        no-repeat center;
      background-size: contain;
      margin-right: 20px;
      &.active {
        background: url(../assets/images/common/reg_tologin_agree.png) no-repeat
          center;
        background-size: contain;
      }
    }
