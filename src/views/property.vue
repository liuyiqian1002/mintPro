  ...
  <div class="property_wrap">
      <div class="top">
        <header>
            ...
            <img @click="showMeMenu  = true" src="../assets/images/common/me_user.png" alt="">
            ...
            <ul>
                <li>
                    <div class="" @click="petty">
                        <div  :class="['checkbox',{checked:isPetty} ]">
                        </div>
                ...
                <li>
                    <div>
                        <input v-model="KeyWord" @keydown.enter="search" @blur="getUserCommodityAccountsInfo" type="text" :placeholder="$t('property.seach')">
                    </div>
                </li>
            </ul>
        </div>
      ...
      <div class="contnet">
          <div>
              <van-empty
                ...
                :image="emptyImg"
              />
            <div class="card" v-for="(i  ) in DataList"  @click="toRecord(i)">
                <p >{{i.Coin}}</p>
                <ul>
                    <li>
    ...
    <mainFooter />
    <van-popup   v-model="showMeMenu" position="left" :style="{height:'100%', width: '80%' }">
        <div class="me_menu">
            ...
            <div class="avatar">
                ...
                <div>
                    <p>{{  UserInfo.EnCode }} <span class="tag">V{{ (UserInfo.UserGrade + 1)}}</span></p>
      ...
      <div class="cell" @click="showMeMenu = false,$router.push('/set_lan')">
        <div class="cion">
...
<style lang="less" scoped>
    .property_wrap{
        ...
        .top{
            ...
            .acc_info{
                background: url(../assets/images/common/property_top_bg.png) no-repeat;
                padding:50px 40px;
                height: 360px;
                margin:20px 20px;
                    ...
                    li {
                        >div{
                            ...
                            input{
                                ...
                                padding-left:40px;
                                background: url(../assets/images/common/properth_search.png) no-repeat 5px center;
